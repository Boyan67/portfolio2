  ...
  return (
      <div className={`${darkToggle ? 'dark' : ''}`} id={"landing-page"}>
        ...
        <div id={"projects"}
          ...
          <div className={"flex flex-row flex-wrap justify-between w-full lg:w-[75%] self-center "}>
                ...
                <div className={"md:w-[600px] w-[100%]"}>
                  ...
                  <button onClick={() => openPopup(project.title, project.type, project.link, project.num)}>
                    <img
                        src={project.image}
                        alt="Placeholder img"
                        className={"md:w-[600px] hover:scale-[1.03] hover:shadow-xl ease-in-out duration-300 shadow"}/>
                  </button>
                  <ProjectCard
